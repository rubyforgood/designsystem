...
# Documentation cross-reference checking (dead #anchor links) used to live here. It had zero
# Rails/ERB coupling -- pure File.read and regex over .md files -- so on 2026-09-23 it was
# extracted to bin/design/doc-link-audit.rb, the one piece of this file that genericized instead
# of needing to be demoted to a Rails-specific reference. Run it separately.
